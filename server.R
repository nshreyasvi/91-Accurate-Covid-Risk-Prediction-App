...
model <- readRDS("C:/Users/shrey/Downloads/covid_machine_learning_model/c50_model.rds")
dataset <- read.csv("C:/Users/shrey/Downloads/covid_machine_learning_model/covid.csv", sep=' ', header = T)
